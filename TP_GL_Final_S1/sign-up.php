<?php
    ...
    // Redirect the user to another page if already logged in
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Navigation -->
    <?php include 'navbar.php'; ?> <!-- end of navbar -->
 <!-- end of navbar -->
    <!-- end of navigation -->
    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Sign Up</h1>
                   <p>Fill out the form below to sign up. Already signed up? Then just <a class="white" href="log-in.php">Log In</a></p> 
                    <div class="form-container">
                        <form method="post" action="verify.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control-input" id="cpassword" name="cpassword" required>
